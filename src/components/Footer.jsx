  ...
  return (
    <footer className="py-12 px-6 border-t border-gray-200 dark:border-[#334155]">
      <div className="max-w-6xl mx-auto">
        <div className="mb-10">
          <h2 className="text-3xl md:text-4xl font-[family-name:var(--font-display)] font-bold text-black dark:text-white mb-4">
            Let's build together.
          </h2>
          <a
            href="mailto:JohnKenGerodias05@gmail.com"
            className="text-lg text-[#0058be] dark:text-[#60a5fa] hover:underline font-medium"
          >
            JohnKenGerodias
          </a>
        </div>

        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pt-8 border-t border-gray-200 dark:border-[#334155]">
          ...
          <div className="flex items-center gap-3">
            <a
              href="#"
              className="w-9 h-9 rounded-full bg-gray-100 dark:bg-[#334155] flex items-center justify-center text-[#4c4546] dark:text-[#94a3b8] hover:text-[#0058be] dark:hover:text-[#60a5fa] transition-colors"
              aria-label="GitHub"
            >
          ...
          <p className="text-xs text-[#7e7576] dark:text-[#4c4546] font-[family-name:var(--font-mono)] tracking-wider">
            &copy; {new Date().getFullYear()} DESIGNED & CODED BY JKG
          </p>
        </div>
      </div>
    </footer>
